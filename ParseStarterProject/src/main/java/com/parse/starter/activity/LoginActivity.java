...
//        ParseUser.logOut();
        ...
        //Adicionar evento de click no botão logar
    ...
    private void verificarLogin(String usario, String senha) {
        ParseUser.logInInBackground(usario, senha, new LogInCallback() {
            @Override
